...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const lowPopAnimals = array.filter(item => item.population < 5);
  ...
  */
  ...
  function USApop(array){
    const totalAnimalPopulation =  array.reduce(function(accumulator, item){
...
const cuboid = new CuboidMaker(testCuboid);
...
const cuboidTwo = new CuboidMakerTwo(testCuboid2);
